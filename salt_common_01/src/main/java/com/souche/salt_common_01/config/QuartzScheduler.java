...
public class QuartzScheduler {
     ...
     */
    public void startJob(String name,String startTime) throws SchedulerException {
 ...
 /*   private void startJob1(Scheduler scheduler,String name,String startTime) throws SchedulerException {
    ...
    public void startJob2()  {
        JobDetail jobDetail = JobBuilder.newJob(SchedulerQuartzJob2.class).withIdentity("updateNginx", "group2").build();
        CronScheduleBuilder cronScheduleBuilder = CronScheduleBuilder.cronSchedule("0 0 22 * * ?");
        CronTrigger cronTrigger = TriggerBuilder.newTrigger().withIdentity("updateNginx", "group2")
                .withSchedule(cronScheduleBuilder).build();
        try {
            scheduler.scheduleJob(jobDetail, cronTrigger);
    ...
    public void startJob3()  {
        JobDetail jobDetail = JobBuilder.newJob(SchedulerQuartzJob2.class).withIdentity("updateSalt", "group2").build();
        CronScheduleBuilder cronScheduleBuilder = CronScheduleBuilder.cronSchedule("0 */2 * * * ?");
        CronTrigger cronTrigger = TriggerBuilder.newTrigger().withIdentity("updateSalt", "group2")
                .withSchedule(cronScheduleBuilder).build();
        try {
            scheduler.scheduleJob(jobDetail, cronTrigger);
        } catch (SchedulerException e) {
    ...
    public void startJob4()  {
        JobDetail jobDetail = JobBuilder.newJob(SchedulerQuartzJob2.class).withIdentity("failNum", "group2").build();
        CronScheduleBuilder cronScheduleBuilder = CronScheduleBuilder.cronSchedule("0 0 14 * * ?");
        CronTrigger cronTrigger = TriggerBuilder.newTrigger().withIdentity("failNum", "group2")
                .withSchedule(cronScheduleBuilder).build();
        try {
            scheduler.scheduleJob(jobDetail, cronTrigger);
        } catch (SchedulerException e) {
    ...
    public void startJob5()  {
        JobDetail jobDetail = JobBuilder.newJob(SchedulerQuartzJob2.class).withIdentity("syhm", "group2").build();
        CronScheduleBuilder cronScheduleBuilder = CronScheduleBuilder.cronSchedule("0 0 */10 * * ?");
        CronTrigger cronTrigger = TriggerBuilder.newTrigger().withIdentity("syhm", "group2")
                .withSchedule(cronScheduleBuilder).build();
        try {
            scheduler.scheduleJob(jobDetail, cronTrigger);
        } catch (SchedulerException e) {
